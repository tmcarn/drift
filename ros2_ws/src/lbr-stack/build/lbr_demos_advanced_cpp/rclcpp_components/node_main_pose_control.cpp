...
#define NODE_MAIN_LOGGER_NAME "pose_control"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpose_control_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<lbr_demos::PoseControlNode>";
