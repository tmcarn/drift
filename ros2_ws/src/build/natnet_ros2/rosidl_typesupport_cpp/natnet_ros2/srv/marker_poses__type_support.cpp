...
static const _MarkerPoses_Event_type_support_symbol_names_t _MarkerPoses_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, natnet_ros2, srv, MarkerPoses_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, natnet_ros2, srv, MarkerPoses_Event)),
  }
};
...
{
  return &::natnet_ros2::srv::rosidl_typesupport_cpp::MarkerPoses_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, natnet_ros2, srv, MarkerPoses_Event)() {
  return get_message_type_support_handle<natnet_ros2::srv::MarkerPoses_Event>();
}
...
static const rosidl_service_type_support_t MarkerPoses_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<natnet_ros2::srv::MarkerPoses_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<natnet_ros2::srv::MarkerPoses_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<natnet_ros2::srv::MarkerPoses_Event>(),
