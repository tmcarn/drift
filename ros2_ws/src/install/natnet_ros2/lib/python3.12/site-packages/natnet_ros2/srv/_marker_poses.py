...
class Metaclass_MarkerPoses_Event(type):
    """Metaclass of message 'MarkerPoses_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__marker_poses__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__marker_poses__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__marker_poses__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__marker_poses__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__marker_poses__event
...
class MarkerPoses_Event(metaclass=Metaclass_MarkerPoses_Event):
    """Message class 'MarkerPoses_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<natnet_ros2/MarkerPoses_Request, 1>',
        'response': 'sequence<natnet_ros2/MarkerPoses_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['natnet_ros2', 'srv'], 'MarkerPoses_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['natnet_ros2', 'srv'], 'MarkerPoses_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from natnet_ros2.srv import MarkerPoses_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MarkerPoses_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MarkerPoses_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from natnet_ros2.srv import MarkerPoses_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MarkerPoses_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MarkerPoses_Response'"
...
class Metaclass_MarkerPoses(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _marker_poses.Metaclass_MarkerPoses_Event._TYPE_SUPPORT is None:
                _marker_poses.Metaclass_MarkerPoses_Event.__import_type_support__()
...
class MarkerPoses(metaclass=Metaclass_MarkerPoses):
    ...
    from natnet_ros2.srv._marker_poses import MarkerPoses_Event as Event
