...
static const _LBRWrenchCommand_type_support_symbol_names_t _LBRWrenchCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbr_fri_idl, msg, LBRWrenchCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lbr_fri_idl, msg, LBRWrenchCommand)),
  }
};
...
{
  return &::lbr_fri_idl::msg::rosidl_typesupport_cpp::LBRWrenchCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lbr_fri_idl, msg, LBRWrenchCommand)() {
  return get_message_type_support_handle<lbr_fri_idl::msg::LBRWrenchCommand>();
}
