...
#include "lbr_fri_idl/msg/detail/lbr_wrench_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lbr_fri_idl::msg::LBRWrenchCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lbr_fri_idl
max_serialized_size_key_LBRWrenchCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const lbr_fri_idl::msg::LBRWrenchCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lbr_fri_idl::msg::LBRWrenchCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LBRWrenchCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const lbr_fri_idl::msg::LBRWrenchCommand *>(
...
static size_t _LBRWrenchCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LBRWrenchCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LBRWrenchCommand__callbacks = {
  "lbr_fri_idl::msg",
  "LBRWrenchCommand",
...
static rosidl_message_type_support_t _LBRWrenchCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LBRWrenchCommand__callbacks,
...
{
  return &lbr_fri_idl::msg::typesupport_fastrtps_cpp::_LBRWrenchCommand__handle;
}
