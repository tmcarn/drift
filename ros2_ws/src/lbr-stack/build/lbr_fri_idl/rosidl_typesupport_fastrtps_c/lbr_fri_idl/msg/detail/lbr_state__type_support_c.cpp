...
bool cdr_serialize_lbr_fri_idl__msg__LBRState(
  const lbr_fri_idl__msg__LBRState * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lbr_fri_idl
bool cdr_deserialize_lbr_fri_idl__msg__LBRState(
  eprosima::fastcdr::Cdr & cdr,
  lbr_fri_idl__msg__LBRState * ros_message)
{
  // Field name: sample_time
  {
    cdr >> ros_message->sample_time;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lbr_fri_idl
bool cdr_serialize_key_lbr_fri_idl__msg__LBRState(
  const lbr_fri_idl__msg__LBRState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: sample_time
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lbr_fri_idl
size_t get_serialized_size_key_lbr_fri_idl__msg__LBRState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LBRState__ros_msg_type * ros_message = static_cast<const _LBRState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lbr_fri_idl
size_t max_serialized_size_key_lbr_fri_idl__msg__LBRState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lbr_fri_idl__msg__LBRState * ros_message = static_cast<const lbr_fri_idl__msg__LBRState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lbr_fri_idl__msg__LBRState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lbr_fri_idl__msg__LBRState * ros_message = static_cast<lbr_fri_idl__msg__LBRState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lbr_fri_idl__msg__LBRState(cdr, ros_message);
}
