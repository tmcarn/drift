...
#define NODE_MAIN_LOGGER_NAME "pose_planning"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpose_planning_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<lbr_demos::PosePlanningNode>";
