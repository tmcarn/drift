...
class LBRState(metaclass=Metaclass_LBRState):
    ...
    def __init__(self, **kwargs):
        ...
        if 'external_torque' not in kwargs:
            ...
            self.external_torque = kwargs.get('external_torque')
        if 'ipo_joint_position' not in kwargs:
            self.ipo_joint_position = numpy.zeros(7, dtype=numpy.float64)
        else:
            self.ipo_joint_position = kwargs.get('ipo_joint_position')
    ...
    def __eq__(self, other):
        ...
        if self.time_stamp_nano_sec != other.time_stamp_nano_sec:
            return False
        if any(self.measured_joint_position != other.measured_joint_position):
            return False
        if any(self.commanded_joint_position != other.commanded_joint_position):
            return False
        if any(self.measured_torque != other.measured_torque):
            return False
        if any(self.commanded_torque != other.commanded_torque):
            return False
        if any(self.external_torque != other.external_torque):
            return False
        if any(self.ipo_joint_position != other.ipo_joint_position):
            return False
